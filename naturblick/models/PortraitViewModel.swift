                ...
                .map { portraitId, rows in
                    ...
                    return Portrait(
                        ...
                        species: Species(
                            ...
                            maleUrlSource: row[Species.Definition.table[Species.Definition.maleUrlSource]],
                            maleUrlOwner: row[Species.Definition.table[Species.Definition.maleUrlOwner]],
                            maleUrlOwnerLink: row[Species.Definition.table[Species.Definition.maleUrlOwnerLink]],
                            maleUrlLicense: row[Species.Definition.table[Species.Definition.maleUrlLicense]],
